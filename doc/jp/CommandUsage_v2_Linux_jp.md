...
- デバイスID: 以下の値から始まり、追加する毎に1ずつ増えていきます。各サーバに同じデバイスIDのデバイスを設定してください。
  - カーネルモードハートビート/ユーザモードハートビート: 0 (上限: 99)
  - ディスクハートビート: 300 (上限: 399)
  - BMCハートビート: 600 (上限: 699)
  - Witnessハートビート: 700 (上限: 799)
  - PING方式NP解決リソース: 10200 (上限: 10299)
  - HTTP方式NP解決リソース: 10700 (上限: 10799)
- info: 以下の値を入力してください。
